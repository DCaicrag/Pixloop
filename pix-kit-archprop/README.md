...
This source keeps all code for the PIX Citybot project.

It is developed based on Autoware Tier4 Architecture Proposal, tag 0.9.1.
...
3. (PIX Step) Update submodules and deploy perception models

```sh
git submodule init
git submodule update
cd scripts
./deploy_perception_models.sh
cd -
```
