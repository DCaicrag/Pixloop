...
class ZyCan(object):
    ...
    def __init__(self,channel):
        ...
        # make can msgs --
        self.can_byte_data = [0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0] 
        self.__can_msgs = Message(data = self.can_byte_data, is_extended_id=False, arbitration_id=0x101)
    

    def can_send(self, rate = 5):
        """can msgs  send to 0x101
        parameter:
            rate -- send rate 5HZ
        return:
            None
